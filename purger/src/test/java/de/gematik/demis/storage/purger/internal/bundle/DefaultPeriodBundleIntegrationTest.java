...
class DefaultPeriodBundleIntegrationTest extends DefaultPeriodInternalPurgeIntegrationTest {
  ...
  protected void createDefaultPeriodTests(
    ...
    BundleIntegrationTest.createDefaultPeriodBundles(repository, activeRecords, expiredRecords);
  }
